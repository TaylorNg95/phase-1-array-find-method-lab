...
function superbowlWin(recordArray){
    const winningYearRecord = recordArray.find(testWin);
    if(winningYearRecord !== undefined) {
        return winningYearRecord.year
    } else {return winningYearRecord};
}

function testWin(element){
